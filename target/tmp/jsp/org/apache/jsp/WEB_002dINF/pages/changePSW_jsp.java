 ...
 * Generated at: 2017-12-14 07:03:41 UTC
...
return;
    ...
    try {
      ...
      out.write("\" id = \"realpassword\">\r\n");
      out.write("\t\t<input type=\"hidden\"  value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${user.username}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\" id = \"username\">\r\n");
      out.write("\t\t当前密码 : <input type=\"text\"  id=\"tmpPSW\" name=\"tmpPSW\"><br/>\r\n");
      out.write("\t\t修改密码 : <input type=\"text\" id=\"changePSW01\"><br/>\r\n");
      out.write("\t\t重复密码 : <input type=\"text\" id=\"changePSW02\"><br />\r\n");
      out.write("\t\t</form>\r\n");
      out.write("\t\t<button onclick=\"changePSW();\">修改</button>\r\n");
      out.write("\t\t<button onclick=\"forgetPSW();\">忘记密码</button>\r\n");
      out.write("\r\n");
      out.write("\t</div>\r\n");
      out.write("\r\n");
      out.write("</body>\r\n");
      ...
      out.write("\t\r\n");
      out.write("\tvar realpassword = $('#realpassword').val();\r\n");
      out.write("\tvar tmpPSW = $('#tmpPSW').val();\r\n");
      out.write("\t\r\n");
      out.write("\tvar changePSW01 = $('#changePSW01').val();\t\r\n");
      out.write("\tvar changePSW02 = $('#changePSW02').val();\r\n");
      out.write("// \tif(realpassword != tmpPSW){\r\n");
      out.write("// \t\talert(\"当前密码错误\");\r\n");
      out.write("// \t\treturn;\r\n");
      out.write("// \t}\t\r\n");
      out.write("\tif(tmpPSW == changePSW01){\r\n");
      out.write("\t\talert(\"逗我呢\");\r\n");
      out.write("\t\treturn;\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tif(changePSW01 != changePSW02){\r\n");
      out.write("\t\talert(\"两次密码不相同，请确认后再提交\");\r\n");
      out.write("\t\treturn;\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tvar changeform = {\t\t\t\t\r\n");
      out.write("\t\t\ttmpPSW : $('#tmpPSW').val(),\r\n");
      out.write("\t\t\tchangePSW01 : $('#changePSW01').val(),\r\n");
      out.write("\t\t\tchangePSW02 : $('#changePSW02').val()\r\n");
      out.write("\t\t};\r\n");
      out.write("\t\r\n");
      out.write("\t$.post('/user/changePSW.do',changeform,callback);\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function callback(data,status) {\r\n");
      out.write("\tvar AjaxDto = data;\r\n");
      out.write("\tif(AjaxDto.flag == false){\r\n");
